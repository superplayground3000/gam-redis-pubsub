# Redis Stream to Redpanda Connect to NATS Stream
...
2. Redpanda Connect captures changes by central Redis Stream and propogate the content to the NATS JetStream
3. Another Redpanda Connect listens to JetStream, and propogate changes to region Redis
